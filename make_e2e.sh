...
SIMPLIFIED_LONG_SHORT="--type_multi_nominal 0.8 0.2 --workflow_list kafka_single nginx_single --clients ${TOTAL_CLIENTS_HIGH_LOAD} --target_clients ${TOTAL_CLIENTS_HIGH_LOAD} --static_load_level True"
