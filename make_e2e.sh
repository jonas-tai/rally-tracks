...
HIGH_LOAD="--draw_size True --zipf 1 --clients ${TOTAL_CLIENTS_HIGH_LOAD} --target_clients ${TOTAL_CLIENTS_HIGH_LOAD} --pareto 0.63 --size_max 50 --request_range 20 --load_period 10 --min_load 1 --size_multiplier 1"
HIGH_EVICT="--draw_size True --zipf 1 --clients ${TOTAL_CLIENTS_MED_LOAD} --target_clients ${TOTAL_CLIENTS_HIGH_LOAD} --num_workflow_types 6 --pareto 0.4 --size_max 200 --request_range 30  --load_period 10 --min_load 1 --size_multiplier 1"
HIGH_CACHE="--draw_size True --zipf 3 --clients ${TOTAL_CLIENTS_MED_LOAD} --target_clients ${TOTAL_CLIENTS_HIGH_LOAD} --num_workflow_types 4 --pareto 0.6 --size_max 5 --request_range 30  --load_period 10 --min_load 1 --size_multiplier 1"

SEED="1"
OUT_PATH="elastic/logs/workflows/custom/microbenchmarks"
python make_workload.py ${HIGH_LOAD} --out_folder ${OUT_PATH}/high_load --mode 'n' --max_workload_time 600 --seed ${SEED}
python make_workload.py ${HIGH_CACHE} --out_folder ${OUT_PATH}/high_cache --mode 'n' --max_workload_time 600 --seed ${SEED}
python make_workload.py ${HIGH_EVICT} --out_folder ${OUT_PATH}/high_evict --mode 'n' --max_workload_time 600 --seed ${SEED}
